...
export default function CtaSection() {
  return (
    <section className="py-20 md:py-24 bg-secondary text-secondary-foreground relative overflow-hidden">
      ...
      <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-primary/8 blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div className="reveal-on-scroll stagger-1">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-6 border border-white/20 rounded-full bg-white/8">
            ...
            <span className="text-xs font-700 tracking-widest text-secondary-foreground/70 uppercase">
              Atención directa
            </span>
          </div>
